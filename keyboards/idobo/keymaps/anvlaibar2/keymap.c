...
// custom keycodes
#define LDBLQUT UC(0x00AB)
#define RDBLQUT UC(0x00BB)
#define AMPR UC(0x0026)
#define GRAVE UC(0x0060)
#define SCOLON UC(0x003B)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QW] = LAYOUT_ortho_5x15( \
    KC_GESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, NO_PLUS, NO_BSLS, GRAVE, KC_BSPC, \
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, NO_AA, NO_QUOT, KC_LCBR, KC_RCBR, \
    NO_PIPE, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, NO_OSLH, NO_AE, NO_ASTR, KC_RSPC, KC_ENT, \
    KC_LSPO, NO_LESS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, NO_MINS, SCOLON, KC_UP, KC_DEL, \
    KC_LCTL, KC_LGUI, KC_HYPR, KC_LALT, TO(2), KC_SPC, KC_SPC, TO(1), KC_PSLS, KC_RALT, OSL(1), AMPR, KC_LEFT, KC_DOWN, KC_RGHT \
  ),
 ...
 /* Function & Media keys - LAYER 1
	...
	*/
 	[_FN] = LAYOUT_ortho_5x15( \
  	...
  	KC_LOCK, ___, XXX, XXX, XXX, XXX, XXX, XXX, XXX, LOREM, XXX, XXX, LDBLQUT, LDBLQUT, ___, \
  	___, XXX, XXX, XXX, XXX, XXX, XXX, XXX, XXX, XXX, XXX, XXX, XXX, KC_PGUP, ___, \
  	RESET, ___, ___, ___, TO(0), ___, ___, TO(2), ___, XXX, XXX, XXX, KC_HOME, KC_PGDN, KC_END \
	),
 ...
 /* RGB-controls - LAYER 2
	...
	*/
 	[_RGB] = LAYOUT_ortho_5x15( \
  	...
  	___, ___, XXX, ___, TO(0), ___, ___, TO(0), ___, XXX, XXX, XXX, RGB_M_T, RGB_M_G, RGB_M_SN \
	),
};
